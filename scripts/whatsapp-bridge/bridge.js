 ...
 *
 * Usage:
 *   node bridge.js --port 3000 --session ~/.cortex/whatsapp/session
 */
...
// env (CORTEX_HOME-aware, new cache/ layout).  Fall back to the legacy
...
const DEFAULT_REPLY_PREFIX = '⚕ *Athena Agent*\n────────────\n';
...
async function startSocket() {
  ...
  sock = makeWASocket({
    ...
    browser: ['Athena Agent', 'Chrome', '120.0'],
