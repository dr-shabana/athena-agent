#!/usr/bin/env python3
"""Build the Athena Skills Index — a centralized JSON catalog of all skills.
...
`athena skills search/install` can use it without hitting the GitHub API.
...
# Ensure CORTEX_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Athena Skills Index...", flush=True)
