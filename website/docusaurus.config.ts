...
const config: Config = {
  ...
  url: 'https://athena-agent.nousresearch.com',
  baseUrl: '/docs/',

  organizationName: 'NousResearch',
  projectName: 'athena-agent',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/dr-shabana/athena-agent/edit/main/website/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    image: 'img/athena-agent-banner.png',
    colorMode: {
      defaultMode: 'dark',
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://athena-agent.nousresearch.com/desktop',
          label: 'Download',
          position: 'left',
        },
        {
        ...
        {
          href: 'https://athena-agent.nousresearch.com',
          label: 'Home',
          position: 'right',
        },
        {
          href: 'https://github.com/dr-shabana/athena-agent',
          label: 'GitHub',
          position: 'right',
        },
        {
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'GitHub Issues', href: 'https://github.com/dr-shabana/athena-agent/issues' },
        ...
        },
        {
          title: 'More',
          items: [
            { label: 'Desktop Download', href: 'https://athena-agent.nousresearch.com/desktop' },
            { label: 'GitHub', href: 'https://github.com/dr-shabana/athena-agent' },
