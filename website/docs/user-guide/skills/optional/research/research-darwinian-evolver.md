...
| Version | `0.1.0` |
| Author | Bihruze (Asahi0x), Athena Agent |
| License | MIT |
...
import upstream classes into Athena itself.
...
Open `~/.cortex/cache/darwinian-evolver/darwinian_evolver/darwinian_evolver/lineage_visualizer.html`
...
7. **AGPL.** Never `from darwinian_evolver import ...` inside Athena core.
   Custom driver scripts under `~/.cortex/skills/...` are user-side and fine.
