...
Set your Tenor API key in your environment (add to `~/.cortex/.env`):
...
- GIF URLs can be used directly in markdown: `![alt](https://github.com/dr-shabana/athena-agent/blob/main/skills/media/gif-search/url)`
