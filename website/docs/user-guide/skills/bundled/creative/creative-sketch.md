...
| Version | `1.0.0` |
| Author | Athena Agent (adapted from gsd-build/get-shit-done) |
| License | MIT |
...
**Verify variants visually — use Athena' browser tools.** Don't just write HTML and hope it renders; load each variant and look at it:
