  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the Athena Agent community is actually building. Every tile
      ...
      <div className={styles.footer}>
        ...
        <a
          href="https://github.com/dr-shabana/athena-agent/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
