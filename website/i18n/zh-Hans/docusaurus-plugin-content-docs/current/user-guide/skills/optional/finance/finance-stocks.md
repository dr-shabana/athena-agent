...
```
SCRIPT=~/.cortex/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.cortex/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
