...
| 版本 | `0.2.0` |
| 作者 | Deniz Alagoz (gizdusum)，由 Athena Agent 增强 |
| 许可证 | MIT |
...
辅助脚本路径：~/.cortex/skills/blockchain/solana/scripts/solana_client.py
...
# 确认连通性
python3 ~/.cortex/skills/blockchain/solana/scripts/solana_client.py stats
```
...
```bash
python3 ~/.cortex/skills/blockchain/solana/scripts/solana_client.py \
...
```bash
python3 ~/.cortex/skills/blockchain/solana/scripts/solana_client.py price BONK
python3 ~/.cortex/skills/blockchain/solana/scripts/solana_client.py price JUP
python3 ~/.cortex/skills/blockchain/solana/scripts/solana_client.py price SOL
python3 ~/.cortex/skills/blockchain/solana/scripts/solana_client.py price DezXAZ8z7PnrnRJjz3wXBoRgixCa6xjnB7YaB1pPB263
```
