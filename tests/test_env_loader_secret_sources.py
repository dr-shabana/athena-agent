"""Tests for the secret-source tracking in ``cortex_cli.env_loader``.
...
from cortex_cli import env_loader  # noqa: E402
...
def test_apply_external_secret_sources_dedupes_within_process(tmp_path, monkeypatch):
    ...
    hot modules (cli.py, cortex_cli/main.py, run_agent.py, ...).  The
    ...
    runs exactly once per CORTEX_HOME per process.
    """
    ...
    # cli.py, cortex_cli/main.py, run_agent.py, trajectory_compressor.py,
