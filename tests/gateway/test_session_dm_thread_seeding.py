...
def store(tmp_path, monkeypatch):
    ...
    ~/.cortex/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at cortex_state import time, before pytest's CORTEX_HOME monkeypatch
    fires — the autouse fixture's CORTEX_HOME override doesn't help here.)
    """
    import cortex_state
