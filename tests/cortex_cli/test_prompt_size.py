...
from cortex_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(cortex_home, memory_text="", user_text=""):
    mem_dir = cortex_home / "memories"
...
def _seed_skill(cortex_home, name, description):
    skill_dir = cortex_home / "skills" / "demo" / name
