...
# helper (and need the autouse stub in tests/cortex_cli/conftest.py disabled),
...
def test_quarantine_actionable_warning_when_everything_fails(
    ...
    assert "Athena Desktop" in captured or "gateway" in captured.lower()
