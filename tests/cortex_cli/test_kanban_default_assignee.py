...
def isolated_kanban_home(monkeypatch):
    ...
    # Force-reimport so the fresh CORTEX_HOME is picked up.
    ...
    # gives each test its own monkeypatched CORTEX_HOME so no cross-test
    # contamination.
...
def test_dispatch_result_has_auto_assigned_default_field():
    ...
    from cortex_cli.kanban_db import DispatchResult
    r = DispatchResult()
