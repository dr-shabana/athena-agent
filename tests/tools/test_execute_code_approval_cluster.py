...
def test_env_scrub_hermes_allowlist_and_secret_blocks():
    ...
    env = {
        ...
        "CORTEX_HOME": "/h", "HERMES_PROFILE": "p",
    ...
    for kept in ("CORTEX_HOME", "HERMES_PROFILE", "HERMES_CONFIG", "HERMES_ENV", "PATH"):
...
def test_env_scrub_logs_dropped_hermes_vars(caplog):
    ...
    env = {
        "CORTEX_HOME": "/h",          # allowlisted → kept, not logged
    ...
    assert "CORTEX_HOME" in out and "PATH" in out
