...
Used by ``athena kanban specify [task_id | --all]``. Takes a task that
...
* This module intentionally mirrors ``cortex_cli/goals.py`` — same aux
...
_SYSTEM_PROMPT = """You are the Kanban triage specifier for the Athena Agent board.
...
def _profile_author() -> str:
    """Mirror of ``cortex_cli.kanban._profile_author``. Kept local to
