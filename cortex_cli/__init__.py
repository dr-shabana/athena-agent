"""
Athena CLI - Unified command-line interface for Athena Agent.
...
def _ensure_utf8():
    ...
    can even start — e.g. `athena setup` on a fresh Pi.
    ...
    cortex_cli/stdio.py::configure_windows_stdio() runs later from the entry
