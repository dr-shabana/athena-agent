...
Entry point: ``athena whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``cortex_cli/main.py``).
...
Athena gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Athena to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Athena needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Athena gateway in another terminal:")
    ...
    print()
    print("  Docs: https://athena-agent.nousresearch.com/docs/user-guide/")
