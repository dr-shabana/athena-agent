"""``athena tools`` subcommand parser.
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'athena tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # athena tools list [--platform cli]
    ...
    # athena tools disable <name...> [--platform cli]
    ...
    # athena tools enable <name...> [--platform cli]
    ...
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `athena tools` runs after you pick a provider that\n"
