"""
Skills configuration for Athena Agent.
`athena skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.cortex/config.yaml under:
...
from cortex_cli.config import cfg_get, load_config, save_config
from cortex_cli.colors import Colors, color
from cortex_cli.platforms import PLATFORMS as _PLATFORMS
