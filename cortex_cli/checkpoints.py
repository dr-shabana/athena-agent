...
def register_cli(parser: argparse.ArgumentParser) -> None:
    """Wire subcommands onto the ``athena checkpoints`` parser."""
    parser.set_defaults(func=cmd_status)  # bare `athena checkpoints` → status
