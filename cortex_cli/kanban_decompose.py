...
Invoked by ``athena kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Athena Agent board.
...
def _profile_author() -> str:
    """Mirror of ``cortex_cli.kanban._profile_author``."""
    return (
