...
Built for [Athena Agent](https://github.com/dr-shabana/athena-agent). Usable in any coding agent. Canonical source lives here; synced to [`dr-shabana/athena-agent/skills/creative/ascii-video`](https://github.com/dr-shabana/athena-agent/tree/main/skills/creative/ascii-video) via PR.
