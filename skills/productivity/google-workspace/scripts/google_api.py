#!/usr/bin/env python3
"""Google Workspace API CLI for Athena Agent.

Uses the Google Workspace CLI (`gws`) when available, but preserves the
existing Athena-facing JSON contract and falls back to the Python client
...
from _cortex_home import get_cortex_home
...
def main():
    parser = argparse.ArgumentParser(description="Google Workspace API for Athena Agent")
