# Athena Achievements Implementation Spec (Detailed)
...
Storage path:
- `~/.cortex/plugins/hermes-achievements/scan_snapshot.json`
...
Checkpoint file (new):
- `~/.cortex/plugins/hermes-achievements/scan_checkpoint.json`
...
- persisted runtime files:
  - `~/.cortex/plugins/hermes-achievements/state.json` (existing unlock state)
  - `~/.cortex/plugins/hermes-achievements/scan_snapshot.json` (new)
  - `~/.cortex/plugins/hermes-achievements/scan_checkpoint.json` (new)
