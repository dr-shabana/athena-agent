...
required — uses aiohttp which is already a Athena dependency.
...
def interactive_setup() -> None:
    ...
    ``cortex_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Athena delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # cortex_cli/setup.py::_setup_mattermost function.
