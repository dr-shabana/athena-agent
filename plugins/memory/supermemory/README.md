...
Config file: `$CORTEX_HOME/supermemory.json`
...
it groups Athena-written memories into a dedicated "Athena" Space in the
...
Use `{identity}` in the `container_tag` to scope memories per Athena profile:
