...
session-scoped state file under ``$CORTEX_HOME/workspace/meetings/.active.json``
...
# File + directory layout (under $CORTEX_HOME):
#
#   workspace/meetings/
...
def _root() -> Path:
    return Path(get_cortex_home()) / "workspace" / "meetings"
