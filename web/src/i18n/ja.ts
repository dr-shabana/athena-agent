...
export const ja: Translations = {
  ...
  pluginsPage: {
    ...
    removeConfirm: "このプラグインを ~/.cortex/plugins/ から削除しますか？",
    removeHint: "削除できるのは ~/.cortex/plugins 配下のユーザーがインストールしたプラグインのみです。",
  ...
  skills: {
    ...
    categories: "カテゴリ",
    filters: "フィルター",
    noSkills: "スキルが見つかりません。スキルは ~/.cortex/skills/ から読み込まれます",
