...
export const ru: Translations = {
  ...
  pluginsPage: {
    ...
    removeConfirm: "Удалить этот плагин из ~/.cortex/plugins/?",
    removeHint: "Удалять можно только плагины, установленные пользователем в ~/.cortex/plugins.",
  ...
  skills: {
    ...
    filters: "Фильтры",
    noSkills: "Навыки не найдены. Навыки загружаются из ~/.cortex/skills/",
