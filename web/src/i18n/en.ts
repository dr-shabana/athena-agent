...
export const en: Translations = {
  ...
  pluginsPage: {
    ...
    removeConfirm: "Remove this plugin from ~/.cortex/plugins/?",
    removeHint: "Only user-installed plugins under ~/.cortex/plugins can be removed.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.cortex/skills/",
