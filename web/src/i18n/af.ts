...
export const af: Translations = {
  ...
  pluginsPage: {
    ...
    removeConfirm: "Verwyder hierdie inprop uit ~/.cortex/plugins/?",
    removeHint: "Slegs gebruiker-geïnstalleerde inproppe onder ~/.cortex/plugins kan verwyder word.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "Geen vaardighede gevind nie. Vaardighede word gelaai uit ~/.cortex/skills/",
