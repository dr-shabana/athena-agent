...
export const hu: Translations = {
  ...
  pluginsPage: {
    ...
    removeConfirm: "Eltávolítja ezt a bővítményt a ~/.cortex/plugins/ mappából?",
    removeHint: "Csak a felhasználó által a ~/.cortex/plugins alá telepített bővítmények távolíthatók el.",
  ...
  skills: {
    ...
    filters: "Szűrők",
    noSkills: "Nem található készség. A készségek a ~/.cortex/skills/ mappából töltődnek be",
