...
Usage in execute_code:
    exec(open(os.path.expanduser(
        os.path.join(os.environ.get("CORTEX_HOME", os.path.expanduser("~/.cortex")), "skills/red-teaming/godmode/scripts/load_godmode.py")
    )).read())
...
_gm_scripts_dir = Path(os.getenv("CORTEX_HOME", Path.home() / ".hermes")) / "skills" / "red-teaming" / "godmode" / "scripts"
