...
Data file: $CORTEX_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_CORTEX_HOME = Path(os.environ.get("CORTEX_HOME", Path.home() / ".hermes"))
DATA_DIR = _CORTEX_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
