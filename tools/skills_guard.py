...
Trust levels:
  - builtin:   Ships with Athena. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.hermes/\.env|\~/\.hermes/\.env',
     ...
     "directly references Athena secrets file"),
    ...
    (r'\.hermes/config\.yaml|\.hermes/SOUL\.md',
     ...
     "references Athena configuration files directly"),
...
# scan. `.skillignore` is the Athena-native name; `.clawhubignore` is honored
