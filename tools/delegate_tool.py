...
# Must match cortex_cli.runtime_provider.RUNTIME_PROVIDER_TYPE_CUSTOM.
...
def _dump_subagent_timeout_diagnostic(
    *,
    ...
    writes a dedicated log under ``~/.cortex/logs/subagent-<sid>-<ts>.log``
...
def _load_config() -> dict:
    ...
    to the persistent config (cortex_cli/config.py load_config()) so that
        ...
        "properties": {
            ...
            "acp_command": {
                ...
                "description": (
                    ...
                    "Leave empty to use the parent's default transport (Athena subagents)."
                ),
            },
            "acp_args": {
                "type": "array",
