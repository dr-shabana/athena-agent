...
class GatewayKanbanWatchersMixin:
    ...
    async def _kanban_dispatcher_watcher(self) -> None:
        ...
        no separate `athena kanban daemon` process needed. When false, the
            ...
            try:
                ...
                if _is_corrupt_board_db_error(exc):
                    ...
                    logger.error(
                        ...
                        "then run `athena kanban init` if you need a fresh board.",
                        slug,
                        fingerprint[0],
                    )
                    return None
        ...
        def _ready_nonempty() -> bool:
            ...
            task on ANY board whose assignee maps to a real Athena profile
            ...
            PATH, missing venv, credential loss for a real Athena profile).
            """
            try:
                boards = _kb.list_boards(include_archived=False)
            except Exception:
        ...
        def _auto_decompose_tick() -> int:
            ...
            """
            try:
                from cortex_cli import kanban_decompose as _decomp
            ...
            for b in boards:
                ...
                prev_env = os.environ.get("CORTEX_KANBAN_BOARD")
                try:
                    os.environ["CORTEX_KANBAN_BOARD"] = slug
                    try:
                    ...
                    if prev_env is None:
                        os.environ.pop("CORTEX_KANBAN_BOARD", None)
                    else:
                        os.environ["CORTEX_KANBAN_BOARD"] = prev_env
            return successes
