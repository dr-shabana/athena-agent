...
There are two ways to add a platform to the Athena gateway:

## Plugin Path (Recommended for Community/Third-Party)

Create a plugin directory in `~/.cortex/plugins/` (or under `plugins/platforms/`
...
**zero changes to core Athena code**.
...
Checklist for integrating a platform directly into the Athena core.
