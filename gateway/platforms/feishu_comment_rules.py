...
Config: ~/.cortex/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.cortex/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_cortex_home()`` helper (CORTEX_HOME-aware and
...
RULES_FILE = get_cortex_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_cortex_home() / "feishu_comment_pairing.json"
